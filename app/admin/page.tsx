...
export default function AdminPage() {
  ...
  // === Place hashPassword function here ===
  ...
  // === The rest of your states and functions ===
  ...
  if (!auth) {
    return (
      <div className="p-8 max-w-md mx-auto">
        ...
        />
        <button
          onClick={handleAdminLogin} // <-- call it here
  ...
  return (
    <div className="p-8 max-w-3xl mx-auto">
      ...
      {/* ... rest of your create user and user list code ... */}
    </div>
  );
}
